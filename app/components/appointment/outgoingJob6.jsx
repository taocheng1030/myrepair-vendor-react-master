...
class AppointmentOutgoingJob6 extends React.Component {
                    ...
                    <Row>
                        ...
                        <Col sm={3} smPush={9} className="pt-lg pl-lg pb45">
                            <div className="text-center">
                                ...
                                <div className="mt45">
                                    ...
                                    <div>
                                        <Button bsClass="btn btn-oval btn-warning btn-outline mine-default-button width270 mt45 mb-lg">Reschedule</Button>
                                    </div>
                                    <div>
                                        <Button bsClass="btn btn-oval btn-warning btn-outline mine-default-button width270 mt-lg">Delete</Button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <Col sm={9} smPull={3} className="mine-border-right">
                            ...
                            <div className="pt-lg mr-lg" style={{ position: 'relative' }}>
                                <div style={{ height: 90, position: 'absolute', top: 80, left: 22 }} className="mine-line-success zIndex0" />
                                <div style={{ height: 80, position: 'absolute', top: 180, left: 22 }} className="mine-line-grey zIndex0" />
                                <div style={{ height: 80, position: 'absolute', top: 180, left: 22 }} className="mine-line-grey zIndex0" />
                                <div style={{ height: 80, position: 'absolute', top: 280, left: 22 }} className="mine-line-grey zIndex0" />
                                <div style={{ height: 80, position: 'absolute', top: 380, left: 22 }} className="mine-line-grey zIndex0" />
                                <div className="flex-left-center mt45 ml-sm">
                                    ...
                                    <Button bsClass="text-bold btn btn-oval btn-success mine-back-success mt width200" onClick={() => this.setState({ showModal5: true })}
                                        style={{ height: 35 }}>View Job report to verify</Button>
                                </div>
...
export default AppointmentOutgoingJob6;
