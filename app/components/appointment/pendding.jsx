...
class AppointmentPendding extends React.Component {
    ...
    render() {
        return (
            <div className="mine-back-white mine-border-bottom mine-border-top" >
                <AppHeader titles={['Pendding', 'Confirmed', 'History']} links={['app-pendding', 'app-confirmed', 'app-history']} cur="Pendding" />
                    ...
                    <Row>
                        ...
                        <Col sm={9} smPull={3} style={{ borderRightWidth: 1, borderRightColor: '#ebebeb', borderRightStyle: 'solid' }}>
                            ...
                            <div className="mine-border-bottom">
                                <div className="font22 mine-font-black mt45">Quick Jobs</div>
                                <div className="flex-left-center mt45 mb45" style={{ marginRight: -15 }}>
                                    <div className="font36 mine-font-info text-bold text-center width70">
                                        18<div className="font22 mine-font-info">Jul</div></div>
                                    <div className="ml-lg">
                                        <div className="font15 text-bold mine-font-info">Maid needed</div>
                                        <div className="font13 mine-font-grey mt">needed on 18, Jul, 2017</div>
                                    </div>
                                </div>
                            </div>
                            <div className="mine-border-bottom">
                                <div className="font22 mine-font-black mt45">Service Packages</div>
                                <div className="flex-left-center mt45 mb45" style={{ marginRight: -15 }}>
                                    <div className="font36 mine-font-success text-bold text-center width70">
                                    </div>
                                    <div className="ml-lg full-width">
                                        <div className="font15 text-bold mine-font-success">Maid needed</div>
                                        <div className="font13 mine-font-grey mt">needed on 18, Jul, 2017</div>
                                    </div>
                            ...
                            <div className="mine-border-bottom mt45">
                                <div className="font22 mine-font-black">Pendding Jobs</div>
                                <div className="flex-left-center mine-back-warning-opacity mt-lg" style={{ marginRight: -15 }}>
                                    <div className="font36 mine-font-success text-bold text-center width70">
...
export default AppointmentPendding;
