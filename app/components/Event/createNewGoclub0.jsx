...
class CreateNewGoclub0 extends React.Component {
        ...
        return (
            <div className="mine-back-white mine-border-bottom mt76" >
                <div style={{ position: 'relative' }}>
                    <Image src="img/mine/goclub_create.png" style={{ height: 300, width: '100%', objectFit: 'none', objectPosition:'0 -300px' }} />
                    <div style={{ position: 'absolute', top: '50%', left: 0, width: '100%', height: '100%' }}>
                        <Row>
                            <Col sm={8} smOffset={2}>
                                <div className="mine-back-title">Create New GoClub</div>
                            </Col>
                        </Row>
                    </div>
                </div>
                <Row className="mt45">
                    <Col sm={8} smOffset={2}>
                        <div className="ml60">
                            <div className="font14 mine-font-warning text-bold">GoClubs</div>
                            <div className="font48 mine-font-grey">Build your community in JacksGoGo!</div>
                            <div className="font18 mine-font-grey mt">Join millions already JacksGoGo!</div>
                            <div className="font24 mine-font-grey text-bold mb-lg mt45">Choose a category for your GoClub</div>
                        </div>
                    </Col>
                </Row>
                <Row>
...
export default CreateNewGoclub0;
