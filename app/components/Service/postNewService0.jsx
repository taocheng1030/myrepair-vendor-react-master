...
class PostNewService0 extends React.Component {
        ...
        return (
            <div className="mine-back-white mine-border-bottom mt76" >
                ...
                <Row className="mt45">
                    <Col sm={8} smOffset={2}>
                        <div className="ml60">
                            <div className="font14 mine-font-warning text-bold">SERVICES</div>
                            <div className="font48 mine-font-grey">List your services with JacksGoGo</div>
                            <div className="font18 mine-font-grey mt">Join millions already JacksGoGo!</div>
                            <div className="font24 mine-font-grey text-bold mb-lg mt45">Choose a category for your service</div>
                        </div>
                    </Col>
                </Row>
                <Row className="mt-lg">
...
export default PostNewService0;
