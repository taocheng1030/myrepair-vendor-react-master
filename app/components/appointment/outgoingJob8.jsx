...
class AppointmentOutgoingJob8 extends React.Component {
    ...
    closeModal() {
        this.setState({ showModal1: false, showModal2: false, showModal3: false, showModal4: false, showModal5: false, showModal6: false, showModal7: false })
    }
    ...
    renderModal() {
        return (
            <div>
                ...
                <Modal show={this.state.showModal6} onHide={this.closeModal.bind(this)} className="no-border-radius modal-width-768">
                    <div style={{ padding: 100 }}>
                        <div className="flex-left">
                            <div className="font22 mine-font-black" style={{ flex: 1 }}>Tip</div>
                        </div>
                        <table className="table mb-mails mine-border-bottom">
                            <tbody>
                                <div className="mb-lg mt-lg height-100" style={{ position: 'relative' }}>
                        ...
                        <div className="flex-center-center" style={{ flexDirection: 'column' }}>
                            <div className="font15 mine-font-grey mt45">
                                If the service provider has given super service, you may reward them  with a trip
                            </div>
                            <Image src="img/mine/Vector Smart Object.png" className="mt45" />
                            <div className="mt45" style={{ width: '100%' }}>
                                <FormControl type="text" placeholder="Tip Amount" className="form-control mine-input" style={{ height: 40, width: '100%' }} />
                            </div>
                            <div className="flex-center-center mt-lg">
                                <div className="mine-normal-button flex-center-center">Cancel</div>
                                <div style={{ width: 30 }} />
                                <div className="mine-normal-button mine-back-warning mine-font-white flex-center-center">Delete</div>
                            </div>
                        </div>
                    </div>
                </Modal>

                <Modal show={this.state.showModal7} onHide={this.closeModal.bind(this)} className="no-border-radius modal-width-768">
                    <div style={{ padding: 100 }}>
                        <div className="flex-left">
                            <div className="font22 mine-font-black" style={{ flex: 1 }}>Review</div>
                        </div>
                        <table className="table mb-mails mine-border-bottom">
                            <tbody>
                                <div className="mb-lg mt-lg height-100" style={{ position: 'relative' }}>
                        ...
                        <div className="font15 mine-font-grey mt45">
                            Congulations on the completed Job!
                        </div>
                        <div className="font15 mine-font-grey mt45">
                            Please leave a review a feedback for the service provider
                        </div>
                        <div className="flex-center-center" style={{ flexDirection: 'column' }}>
                            <div className="mt-lg">
                                <ReactStars
                            ...
                            <div className="mt-lg" style={{ width: '100%' }}>
                                <FormControl type="text" placeholder="e.g. phenomenal work!" className="form-control mine-input" style={{ height: 40, width: '100%' }} />
                            </div>
                        </div>
                        <div className="font15 mine-font-grey flex-left">
                            <Image src="img/mine/icon_jdollars.png" style={{objectFit:'none'}} className="mr"/>to be earned: 10
                        </div>
                        <div className="flex-center-center mt45">
                            <div className="mine-normal-button flex-center-center">Cancel</div>
                            <div style={{ width: 30 }} />
                            <div className="mine-normal-button mine-back-warning mine-font-white flex-center-center">Post Review</div>
                        </div>
                    </div>
                </Modal>
            </div>
                    ...
                    <Row>
                                ...
                                <div className="mt45">
                                    ...
                                    <div>
                                        <div className="mine-normal-button mine-back-warning mine-button-height-50 mt-lg width270 mb-lg"
                                            ...
                                            <span className="font16 text-bold mine-font-white">Review</span>
                                            <Image src="img/mine/button_review.png" style={{ position: 'absolute', left: 20, top: 5 }} />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="mine-normal-button mine-back-warning mine-button-height-50 mt-lg width270 mb-lg"
                                            onClick={() => this.setState({ showModal6: true })}>
                                            <span className="font16 text-bold mine-font-white">Tip</span>
                                            <Image src="img/mine/button_tip.png" style={{ position: 'absolute', left: 20, top: 5 }} />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="mine-normal-button mine-back-warning mine-button-height-50 mt-lg width270 mb-lg"
                        ...
                        <Col sm={9} smPull={3} className="mine-border-right">
                            ...
                            <div className="pt-lg mr-lg" style={{ position: 'relative' }}>
                                <div style={{ height: 250, position: 'absolute', top: 80, left: 22 }} className="mine-line-grey zIndex0" />
                                <div style={{ height: 80, position: 'absolute', top: 340, left: 22 }} className="mine-line-grey zIndex0" />
                                <div style={{ height: 80, position: 'absolute', top: 440, left: 22 }} className="mine-line-grey zIndex0" />
                                <div style={{ height: 80, position: 'absolute', top: 540, left: 22 }} className="mine-line-grey zIndex0" />
...
export default AppointmentOutgoingJob8;
