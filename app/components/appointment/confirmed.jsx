...
class AppointmentConfirmed extends React.Component {
    ...
    render() {
        return (
            <div className="mine-back-white mine-border-bottom mine-border-top" >
                <AppHeader titles={['Pendding', 'Confirmed', 'History']} links={['app-pendding', 'app-confirmed', 'app-history']} cur="Confirmed" />
                <div className="container">
                    <Row>
                        ...
                        <Col sm={9} smPull={3} style={{ borderRightWidth: 1, borderRightColor: '#ebebeb', borderRightStyle: 'solid' }}>
                            ...
                            <div className="mine-border-bottom mt-lg" style={{marginRight:-15}}/>
                            <Pager
