                ...
                <div className="container">
                    ...
                    <Row className="mine-border-bottom">
                        ...
                        <Col sm={3} smPush={9} className="pl0 pt-lg">
                            <div className="mine-item-text-container mt45">
                                <span className="mine-item-text">Filter</span>
                            </div>
                        ...
                        <Col sm={9} smPull={3} className="mine-border-right">
                            ...
                            <div>
                                ...
                                {this.state.data.map((item, index) => {
                                    return (
                                        <div key={index} className="mine-border-bottom mr-lg" style={{ display: 'inline-block' }}>
